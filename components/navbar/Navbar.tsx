   ...
   useEffect(() => {
    ...
    return (
        <div className="w-full h-auto flex flex-row items-center bg-none  shadow-none  py-4">
            ...
            {!isMobile && (
                <div className="flex flex-row  items-center gap-[4rem] w-[45vw] ml-[10vw] xl:flex  xl:pt-4 lg:gap-[2rem] lg:ml-[12vw] xl:gap-[6vw] "> 
            ...
            {!isMobile && !isLoggedIn && (
                <div className="flex flex-row items-center justify-center xl:w-[20vw] gap-[2rem] lg:mr-[1vw] xl:ml-[8vw]">
                    <Link href="/signin">
