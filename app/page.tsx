...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row w-full justify-center items-center mt-[8vw] px-[5vw]">
      ...
      <h1 className="font-bold text-center sm:text-[4vw]  xs:text-[20px] md:text-left text-secondary font-roboto"> Welcome to Care4Pets Clinic </h1>
      </div>
    ...
    <p className="mt-[6vw] xs:text-[15px] lg:text-[1.8vw] text-center text-charcoal font-roboto">
     Your pet’s health and happiness are our top priorities.
   </p>

     
        <p className="mt-[2vw]  xs:text-[15px] text-center lg:text-[1.8vw]  text-charcoal font-roboto">   Book an appointment today and give your furry friends the care they deserve!
        </p>
