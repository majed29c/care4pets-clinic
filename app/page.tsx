...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row w-full justify-center items-center mt-[8vw] px-[5vw]">
      ...
      <h1 className="font-bold text-center sm:text-[4vw]  xs:text-[20px] md:text-left bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-roboto"> Welcome to Care4Pets Clinic </h1>
      </div>
